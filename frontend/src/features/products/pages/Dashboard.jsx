  ...
  return (
    <div className="bg-[#F8F6F2] min-h-screen text-[#1F1F1F] font-sans pb-16 selection:bg-[#D8B03B] selection:text-white">
      ...
      <div className="max-w-[1600px] mx-auto px-6 lg:px-12 xl:px-20 mt-2">
        ...
        {/* Header Section */}
        <div className="mb-10">
            <h1 className="text-[38px] font-semibold text-[#1F1F1F] tracking-tight mb-2" style={{ fontFamily: "Playfair Display, serif" }}>
                My Products
            </h1>
        ...
        {products.length > 0 ? (
            ...
            <div className="py-20 text-center">
                <p className="text-[#777777] text-[14px]">No products listed yet.</p>
            </div>
        )}
