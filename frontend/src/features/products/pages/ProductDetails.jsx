                ...
                <div className="hidden md:flex flex-col gap-3 overflow-y-auto h-full pt-14 pr-2 custom-scrollbar w-[80px] lg:w-[100px] shrink-0 z-10 relative">
                    {displayImages.map((img, idx) => (
                        <button 
                            ...
                            className={`w-full aspect-square shrink-0 rounded-[12px] overflow-hidden border-[2px] transition-all bg-white shadow-sm ${
                      ...
                      <div className="flex flex-wrap gap-4">
                          {values.map((val) => (
                              <button 
                                  ...
                                  className={`px-4 h-12 min-w-[3rem] flex items-center justify-center border text-[13px] font-bold transition-colors ${
