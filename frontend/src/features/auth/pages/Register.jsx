  ...
  return (
    ...
    >
      ...
      <svg className="hidden lg:block absolute inset-0 w-full h-full pointer-events-none opacity-30 z-0">
        <path d="M-10vw,20vh Q 35vw,50vh 25vw,120vh" fill="none" stroke={tokens.primary} strokeWidth="1" />
        <path d="M-5vw,10vh Q 45vw,60vh 30vw,110vh" fill="none" stroke={tokens.primary} strokeWidth="0.5" />
      </svg>
      ...
      <div className="relative z-10 w-full lg:w-[58%] h-auto lg:h-full flex flex-col justify-between p-6 lg:p-16 pt-6 lg:pt-16">
        ...
        >
          ...
          >
            Own Your <span style={{ color: tokens.primary }}>Style.</span>
          </h1>
      ...
      <div className="w-full lg:w-[42%] flex items-center justify-center p-4 md:p-8 lg:p-12 z-20 relative lg:bg-transparent" style={{ backgroundColor: 'transparent' }}>
        ...
        >
            ...
            <label className="flex items-center space-x-3 cursor-pointer py-1 group w-max">
              <div className="relative flex items-center justify-center w-5 h-5">
                <input
                  ...
                  className="peer appearance-none w-5 h-5 border-2 rounded-[4px] transition-all cursor-pointer"
                  style={{ borderColor: tokens.primary }}
                />
                {/* Custom checkmark background driven by peer-checked */}
                <div className="absolute inset-0 rounded-[4px] opacity-0 peer-checked:opacity-100 transition-opacity pointer-events-none" style={{ backgroundColor: tokens.primary }}></div>
          ...
          <motion.a
            ...
            whileHover={{ y: -1, backgroundColor: tokens.surfaceHigh, boxShadow: "0 4px 15px rgba(0,0,0,0.03)" }}
            whileTap={{ scale: 0.98 }}
